...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Se ok, AuthContext aggiorna la sessione e ProtectedRoute fa redirect automatico
  };
  ...
  return (
    <div className="min-h-screen bg-[#0d1320] flex flex-col items-center justify-center px-4">
      ...
      <div className="mb-8 text-center">
        <h1
          className="text-3xl font-bold tracking-widest text-[#c8922d]"
      ...
      <form
        ...
        className="bg-[#152033] border border-[#1e3050] rounded-xl shadow-2xl p-8 w-full max-w-sm"
      >
        <div className="mb-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2.5 rounded font-bold text-sm bg-[#c8922d] text-white hover:bg-[#b07a24] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
